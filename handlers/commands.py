    ...
    async def commands(event):
        ...
        if cmd==".onbot":
            if event.is_group:
                ...
                await event.respond(
                    "👋 Halo, salam kenal. Saya Setyaa — Asisten AI Anda.\n\n"
                    "🤖 Saya hadir untuk membantu menjawab pertanyaan, memberikan informasi, "
                    "serta menemani berbagai kebutuhan Anda.\n\n"
                ...
                await event.respond(
                    "👋 Halo, salam kenal!\n"
                    "Saya Setya, Asisten AI yang siap menemani Anda berbicara, "
                    "bertukar pikiran, atau sekadar menjadi teman cerita.\n\n"
